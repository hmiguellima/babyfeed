...
**
** Created: Fri 1. Mar 00:13:16 2013
...
static const char qt_meta_stringdata_MainView[] = {
    "MainView\0\0babyId\0showBabyPage(int)\0"
    "deleteBaby(int)\0handleActivation()\0"
...
void MainView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->showBabyPage((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->deleteBaby((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->handleActivation(); break;
        case 3: _t->handleShowBabyPage((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 4: _t->handleDeleteBaby((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
// SIGNAL 0
void MainView::showBabyPage(int _t1)
{
...
// SIGNAL 1
void MainView::deleteBaby(int _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
